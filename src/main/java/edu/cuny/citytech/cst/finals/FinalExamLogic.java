package edu.cuny.citytech.cst.finals;
...
public class FinalExamLogic {
    ...
    public FinalExamLogic(Label lblTitle, FlowPane fpNum, TextField txtInput, AnchorPane apContain, Button btnCount, Label lblMessage, ToggleGroup tgRadio, Label lblField) {
    ...
    public void loadNumbers(){
        ...
        FinalExamLogic.loadScene(this::populate, txtInput.getText());
    ...
    public void count(){
        if (txtInput.getText().equals("ABC")){
            ...
            FinalExamLogic.loadScene(this::populateABC, txtInput.getText());
